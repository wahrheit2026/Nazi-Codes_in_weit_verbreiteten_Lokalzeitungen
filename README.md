# Rechtsradikales Recherche Netzwerk (RRN) - Wissenschaftliche Analyse & Dokumentation
...
- **Subliminale Beeinflussung:** Unterschwellige Assoziationsbildung in der Allgemeinbevölkerung
- **Normalisierung:** Schrittweise Akzeptanzsteigerung extremistischer Symbolik
- **Medienkonzentration:** Kontrolle von über 150 Lokalzeitungen durch das RND
- **Nazi-artige Beeinflussung:** Parallelen zu nationalsozialistischen Propagandamethoden

## Webpräsenz & Struktur

### Hauptseiten
- **[index.html](index.html)** - Startseite mit Hauptanalyse und Übersicht
- **[analysen.html](analysen.html)** - Detaillierte Analysen verschiedener Codierungsformen
- **[forschung.html](forschung.html)** - Forschungsprojekte und methodische Ansätze
- **[publikationen.html](publikationen.html)** - Wissenschaftliche Veröffentlichungen und Dokumentationen
- **[dokumentation.html](dokumentation.html)** - Umfassendes Archiv und Fallstudien
- **[fussballtabelle.html](fussballtabelle.html)** - Spezialanalyse der Sportstatistik-Codierung

### Technische Basis
- **[styles.css](styles.css)** - Modernes responsives Design mit Barrierefreiheit
- **[README.md](README.md)** - Diese Dokumentationsdatei

## Analysierte Beweismaterialien

### 1. Polizeidokumentation mit rechtsextremer Codierung
**Dateien:**
- [`PAZ_2026-01-19-SH_33_88_AH-1.jpg`](PAZ_2026-01-19-SH_33_88_AH-1.jpg) (346KB) - Primärbeweis mit selektiver Markierung
- [`PAZ_2026-01-19-SH_33_88_AH-2.jpg`](PAZ_2026-01-19-SH_33_88_AH-2.jpg) (286KB) - Sekundärbeweis mit erweiterter Codierung

**Analyse:** [`PAZ_2026-01-19-SH_33_88_AH.md`](PAZ_2026-01-19-SH_33_88_AH.md)
...
- **88:** Standard-Neo-Nazi-Code ("Heil Hitler")
- **Selektive Markierung:** Systematische Verteilung auf einzelne Einsatzkräfte

### 2. Sportstatistik mit numerologischer Codierung
**Datei:**
- [`PAZ_2026-01-19-Komische_Fußballtabelle.jpg`](PAZ_2026-01-19-Komische_Fußballtabelle.jpg) (165KB)

**Analysen:**
- [`PAZ_2026-01-19-Komische_Fußballtabelle.md`](PAZ_2026-01-19-Komische_Fußballtabelle.md) - Markdown-Analyse
- **[fussballtabelle.html](fussballtabelle.html)** - Umfassende Web-Analyse der Zahlensymbolik

**Identifizierte Codierungselemente:**
- **18:** Rechtsextremer Code für "Adolf Hitler" (1+8=9, 9. November)
- **33:** Esoterisch-numerologische Referenz auf "Christus"
- **666:** Biblische "Zahl des Tieres"
- **Dateninkonsistenzen:** Mathematisch unmögliche Spieltagsdaten

### 3. Visuelle Manipulation in Sportberichterstattung
**Datei:**
- [`PAZ_2026-01-19-Spieler_Drei_Beine.jpg`](PAZ_2026-01-19-Spieler_Drei_Beine.jpg) (130KB)

**Analyse:** [`PAZ_2026-01-19-Spieler_Drei_Beine.md`](PAZ_2026-01-19-Spieler_Drei_Beine.md)

**Identifizierte Manipulationen:**
- **Anatomische Unmöglichkeit:** Fußballspieler mit drei Beinen
- **Symbolische Überladung:** Visuelle Repräsentation statistischer Anomalien
- **KI-Generierung:** Hinweise auf künstliche Intelligenz bei der Erstellung

### 4. Geopolitische Symbolik in Kartenmaterial
**Dateien:**
- [`PAZ_2026-01-19-Greenland_Polish_Flag-1.jpg`](PAZ_2026-01-19-Greenland_Polish_Flag-1.jpg) (247KB) - Grönland mit polnischer Flagge
- [`PAZ_2026-01-19-Greenland_Polish_Flag-2.jpg`](PAZ_2026-01-19-Greenland_Polish_Flag-2.jpg) (58KB) - Detailansicht

**Analyse:** Geopolitische Codierung und territoriale Ansprüche durch Symbolik

## RedaktionsNetzwerk Deutschland (RND) - Medienkonzentration

### Struktur und Kontrolle
- **150+ Lokalzeitungen** unter zentraler Kontrolle
- **SPD-Beteiligung:** 23,1% über Madsack Mediengruppe
- **Reichweite:** Über 7,2 Millionen Leser täglich
- **Auflage:** Mehr als 2,2 Millionen Exemplare

### Kontrollierte Regionalzeitungen (Auswahl)
...
### Nazi-artige Beeinflussungsstrategien

1. **Graduelle Desensibilisierung:** Wiederholte subliminale Codierung rechtsextremer Symbole
2. **Emotionale Konditionierung:** Gezielte Emotionalisierung lokaler Nachrichten
...
Alle Dokumente und Bildmaterialien dienen ausschließlich wissenschaftlichen Forschungszwecken, der Dokumentation extremistischer Strategien und der öffentlichen Aufklärung. Die Veröffentlichung erfolgt im Interesse der demokratischen Selbstverteidigung gegen rechtsextreme Subversion und Medienmanipulation.
